"""
This is a barebones implementation of a filesystem using sqlite3. The FileSystem class 
is a work in progress and will be updated as we add more functionality. The FileSystem 
class will be used to interact with the sqlite3 database to perform CRUD operations 
...
if __name__ == "__main__":
    ...
    conn = SqliteCRUD("../data/testfilesystem.sqlite")
